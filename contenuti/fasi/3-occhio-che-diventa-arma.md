...
titolo: "L'occhio che diventa arma — la trasparenza del campo e l'opacità prodotta"
...
infobox:
  tipo: 1
datazione: "Ottobre 2023 – Agosto 2024"
luoghi: "Avdiivka e il Donetsk; l'intera linea di contatto; il confine di Sumy e il saliente di Sudža nel Kursk"
intentoRusso: "Recuperare l'iniziativa senza riproporre lo sfondamento di massa: demolire da stand-off, degradare la catena di controllo ucraina e far avanzare piccoli gruppi sotto una propria rete di ricognizione e fuoco."
intentoUcraino: "Compensare la scarsità di uomini e munizioni trasformando ogni esposizione russa in un bersaglio economico, poi produrre a Kursk una superiorità informativa locale sufficiente a restituire la manovra."
soluzione: "Interdizione distribuita mediante ricognizione e FPV contro fuoco stand-off, guerra elettronica e opacità deliberatamente prodotta"

# ---- DATI PER LA LINEA DEL TEMPO (compilare sempre) ----
titoloBreve: "L'occhio che diventa arma"
anteprima: "Dopo la difesa che osserva, il drone FPV comprime l'ultimo tratto fra scoperta ed effetto e rende ogni esposizione un bersaglio. La Russia smette di sfidare frontalmente quella rete: colpisce da stand-off e ne attacca il collegamento radio; Avdiivka cade. A Kursk l'Ucraina rovescia localmente il rapporto e dimostra che la trasparenza non è un dato del campo, ma un vantaggio costruito — e perdibile."
dialettica: "Trasparenza contesa"

sistemi_citati: [fpv, umpk, fpv-fibra-ottica]

# ---- IMMAGINE (diritti obbligatori) ----
immagine:
  file: /immagini/fasi/fase-3-T72.png
  alt: "Carro T-72 russo con voluminoso sistema EW improvvisato su pallet, catturato presso Terny"
  credito: "Serhii «Flash» Beskrestnov"
  licenza: "Uso autorizzato su concessione diretta dell'autore. Qualità dell'immagine migliorata tramite AI"
  didascalia: "Terny, aprile 2024: un T-72 russo con una batteria EW improvvisata contro droni FPV, disabilitato e catturato dalla 12ª Brigata forze speciali «Azov»."

# ---- CARTINA TERRITORIALE ----
cartina:
  dataRiferimento: "14 agosto 2024"
  datiTerritoriali: "Occupazione russa degli oblast contesi: • Kharkiv ≈3% • Luhansk ≈99% • Donetsk ≈55% • Zaporižžja ≈63% • Mykolaiv <1% • Kherson ≈57%"
  territori:
    dataset: controllo-fase-3-2024-08-14
    data: "2024-08-14"
  hotspot:
    - tipo: punto
      luogo: avdiivka-donetsk
      etichetta: "Avdiivka"
...
Il 31 ottobre 2023 Valerij Zalužnyj pubblica *Modern Positional Warfare and How to Win It*, nel quale descrive una guerra divenuta posizionale e indica superiorità informativa, guerra elettronica, controbatteria e integrazione delle capacità come problemi da sciogliere {% affV1 "F3-E001" %}. La diagnosi non consegna una legge impersonale. Definisce la contesa: il vantaggio appartiene a chi conserva più a lungo la differenza fra ciò che riesce a osservare e ciò che concede all'avversario di osservare, e sa convertire quella differenza in effetto.
...
<div class="derivazione">
  <span class="der-cap">Le congetture concorrenti della Fase 3</span>
  <div class="der-liv der-liv--strat">
    <span class="der-tag">Problema strategico · l'attrito dopo lo sfondamento negato</span>
    <span class="der-txt">Chi costruisce una <b>superiorità locale di osservazione e di effetto</b> può negare all'avversario la concentrazione e recuperare iniziativa, senza risolvere ancora la gara strategica dell'attrito.</span>
    <div class="der-body">
      <div class="der-liv der-liv--sup">
        <span class="der-tag">Congettura ucraina · interdizione distribuita</span>
        <span class="der-txt">Una rete diffusa di ricognizione, FPV e fuochi può compensare parte dell'inferiorità di uomini e munizioni, trasformando l'esposizione russa in un costo non convertibile in sfondamento.</span>
        <div class="der-body">
          <div class="der-coppia">
            <div class="der-liv der-liv--ann">
              <span class="der-tag">Primo assunto · densità della rete</span>
              <span class="der-txt">Sensori, operatori ed effettori devono essere abbastanza numerosi e distribuiti da rendere persistente l'acquisizione dei bersagli.</span>
            </div>
            <div class="der-liv der-liv--ann">
              <span class="der-tag">Secondo assunto · resilienza del collegamento</span>
              <span class="der-txt">I canali di comando e video devono restare abbastanza affidabili da convertire l'avvistamento in effetto nonostante il disturbo elettronico.</span>
            </div>
          </div>
        </div>
      </div>
      <div class="der-liv der-liv--sup">
        <span class="der-tag">Congettura russa · controconversione</span>
        <span class="der-txt">La rete ucraina può essere resa insufficiente senza restaurare la grande manovra: l'effetto viene portato da <b>fuori dalla fascia tattica esposta</b>, mentre la catena radio avversaria è degradata e piccoli gruppi sfruttano il consumo prodotto.</span>
        <div class="der-body">
          <div class="der-coppia">
            <div class="der-liv der-liv--ann">
              <span class="der-tag">Primo assunto · sottrazione del vettore</span>
              <span class="der-txt">Bombe plananti e altri fuochi stand-off possono demolire posizioni e logistica senza esporre l'aeromobile alla difesa tattica ucraina.</span>
            </div>
            <div class="der-liv der-liv--ann">
              <span class="der-tag">Secondo assunto · asimmetria nello spettro</span>
              <span class="der-txt">EW, ricognizione e droni russi possono restringere l'affidabilità dei collegamenti ucraini abbastanza da aprire finestre a fanteria dispersa e fuochi propri.</span>
            </div>
          </div>
        </div>
      </div>
...
Il successo ucraino rimane localizzato. Non interrompe l'offensiva russa nel Donetsk, non produce una riallocazione tale da rovesciare il saldo aggregato e non restituisce a Kyiv l'iniziativa sull'intero teatro {% affV1 "F3-E017" %}. Impedisce però di trasformare Avdiivka in una legge: nessun attore osserva ovunque, e nessuna densità costruita su un asse si trasferisce automaticamente su un altro.
...
<div class="grp grp--asc">
  ...
  <div class="grp-head"><svg class="grp-ico" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 19 L19 5"/><path d="M19 12 L19 5 L12 5"/></svg><span class="grp-moto">Ascende</span><span class="grp-tag">acquisire, colpire, negare</span></div>
  <div class="el"><div class="el-nome">La rete FPV distribuita</div><div class="el-txt">Comprime il tratto terminale fra acquisizione ed effetto e rende remunerativo colpire il singolo mezzo, la singola squadra o la singola consegna. Non sostituisce l'intera <i>kill chain</i>: la rende <b>capillare, rapida e sacrificabile</b>.</div></div>
  <div class="el"><div class="el-nome">Le FAB con kit UMPK</div><div class="el-txt">La Russia converte bombe sovietiche a caduta libera in munizioni plananti guidate, spostando fuori dalla fascia tattica l'aeromobile che produce l'effetto. Ascendono come risposta alla rete osservante, ma dipendono da targeting, guida e insufficiente interdizione del vettore.</div></div>
  <div class="el"><div class="el-nome">La guerra elettronica integrata</div><div class="el-txt">Comando, video, navigazione e telemetria diventano superfici d'attacco ordinarie. L'EW ascende quando è coordinata con ricognizione, protezione delle emissioni amiche e fuochi; il jammer isolato non possiede da solo il campo.</div></div>
</div>
...
<div class="grp grp--dec">
  ...
  <div class="grp-head"><svg class="grp-ico" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 5 L19 19"/><path d="M19 12 L19 19 L12 19"/></svg><span class="grp-moto">Declina</span><span class="grp-tag">esposizione senza soppressione</span></div>
  <div class="el"><div class="el-nome">L'assalto meccanizzato concentrato e visibile</div><div class="el-txt">Il primo atto di Avdiivka conferma il moto già emerso a Vuhledar e a Zaporižžja: una massa incanalata, acquisita e priva di sufficiente soppressione offre al difensore una sequenza di bersagli prima di produrre profondità.</div></div>
  <div class="el"><div class="el-nome">La fortificazione priva di negazione stand-off</div><div class="el-txt">La posizione preparata non basta quando l'avversario può demolirla dall'esterno della fascia tattica e sostenere il consumo nel tempo. Non declina la fortificazione in sé, ma la pretesa che il solo spessore fisico protegga da una catena aerea non sufficientemente contrastata.</div></div>
</div>
...
<div class="grp grp--tra">
  ...
  <div class="grp-head"><svg class="grp-ico" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 12 a8 8 0 0 1 -13.7 5.6"/><path d="M4 12 a8 8 0 0 1 13.7 -5.6"/><path d="M17.7 3 L17.7 6.4 L14.3 6.4"/><path d="M6.3 21 L6.3 17.6 L9.7 17.6"/></svg><span class="grp-moto">Trasformato</span><span class="grp-tag">compressione e opacità</span></div>
  <div class="el"><div class="el-nome">Il ciclo osservazione–effetto</div><div class="el-txt">Non collassa: si <b>comprime</b>. Ricognizione, decisione e tiro restano funzioni distinte, ma l'FPV porta vista terminale ed effetto sulla stessa piattaforma e riduce il tempo che le separa.</div></div>
  <div class="el"><div class="el-nome">La manovra</div><div class="el-txt">Non ritorna sfidando una trasparenza pienamente costituita. A Kursk riappare dopo compartimentazione, inganno, riduzione dell'ISR, EW e fuochi preparatori: da apertura affidata alla massa a <b>sfruttamento di un'opacità prodotta</b>.</div></div>
  <div class="el"><div class="el-nome">L'FPV radiocomandato</div><div class="el-txt">La guerra elettronica non lo cancella, ma rende il collegamento radio una vulnerabilità dominante. La piattaforma entra in una corsa di frequenze, antenne, relay e procedure che prepara il passaggio alla fibra senza anticiparne la maturità.</div></div>
</div>
