...
titolo: "Il duello logistico — l'artiglieria di massa contro l'interdizione di profondità"
slug: duello-logistico
numero: 1
numeroEtichetta: "Fase 1"
ordine: 1

# ---- INFOBOX (colonna sinistra) ----
infobox:
  tipo: 1
datazione: "Aprile – Novembre 2022"
luoghi: "Donbas (Severodonetsk, Lysychansk), oblast' di Kharkiv, Kherson e riva destra del Dnipro"
intentoRusso: "Convertire la superiorità di fuoco in guadagno territoriale: prima il Luhansk, poi l'intero Donbas."
intentoUcraino: "Spostare il duello dal fuoco alla logistica del fuoco: interdire depositi e ponti per spegnere l'artiglieria alla fonte."
soluzione: "Interdizione di precisione in profondità contro artiglieria di massa"

# ---- DATI PER LA LINEA DEL TEMPO ----
titoloBreve: "Il duello logistico"
anteprima: "Perduta la guerra di decisione, la Russia ripiega sull'attrito e affida all'artiglieria di massa il guadagno del terreno. L'HIMARS sposta il duello sulla logistica che alimenta il fuoco; Kharkiv e Kherson presentano il conto della scommessa."
dialettica: "Fuoco e interdizione"

sistemi_citati: [himars, gmlrs]

# ---- IMMAGINE (diritti obbligatori) ----
immagine:
  file: /immagini/fasi/fase-1-himars.jpg
  alt: "Un lanciarazzi HIMARS ucraino nell'oblast di Zaporizhzhia, inizio giugno 2022"
  credito: "Stato Maggiore delle Forze Armate dell'Ucraina / Wikimedia Commons"
  licenza: "CC BY 4.0"
  didascalia: "Un HIMARS ucraino nel giugno 2022: l'interdizione di precisione che sposta il duello dalla linea di fuoco alla logistica."

# ---- CARTINA ----
cartina:
  dataRiferimento: "13 novembre 2022"
  datiTerritoriali: "Occupazione russa degli oblast contesi: • Kharkiv ≈2% • Luhansk ≈98% • Donetsk ≈57% • Zaporižžja ≈73% • Mykolaiv <1% • Kherson ≈72%"
  hotspot:
    - tipo: punto
      luogo: lysychansk
      etichetta: "Lysychansk"
    ...
    - tipo: punto
      luogo: antonivka-bridge
      etichetta: "Ponte di Antonivka"
      posizioneEtichetta: alto-destra
    - tipo: punto
      luogo: kherson
      etichetta: "Kherson"
...
<div class="derivazione">
  <span class="der-cap">La congettura russa, nella sua struttura annidata</span>
  <div class="der-liv der-liv--strat">
    <span class="der-tag">Assunto strategico · post-Prologo</span>
    <span class="der-txt">La Russia può <b>vincere la guerra per attrito</b>.</span>
    <div class="der-body">
      <div class="der-liv der-liv--sup">
        <span class="der-tag">Assunto di fase · grado operativo</span>
        <span class="der-txt">La <b>superiorità materiale di fuoco</b> converte l'attrito in guadagno territoriale: prima il Luhansk, poi l'intero Donbas.</span>
        <div class="der-body">
          <div class="der-coppia">
            <div class="der-liv der-liv--ann">
              <span class="der-tag">Primo pilastro · logistica del fuoco</span>
              <span class="der-txt">Una rete avanzata e concentrata alimenta una cadenza elevata e resta fuori dalla portata utile dell'interdizione ucraina.</span>
            </div>
            <div class="der-liv der-liv--ann">
              <span class="der-tag">Secondo pilastro · presidio umano</span>
              <span class="der-txt">Fanteria e riserve sono presenti dove servono per tenere le posizioni ottenute e conquistarne di nuove.</span>
            </div>
          </div>
        </div>
      </div>
...
Nel Luhansk il metodo guadagna terreno. Con barrage massicci e avanzata incrementale, le forze russe prendono Severodonetsk — il ritiro ucraino è ordinato il 24 giugno e il controllo pieno arriva il 25 {% aff "confermato" %} — e poi Lysychansk, da cui gli ucraini si ritirano il 2 luglio; il 3 Mosca dichiara il controllo dell'intera regione {% aff "confermato" %}. Lo Stato Maggiore ucraino motiva il ritiro con la «superiorità multipla» russa in artiglieria, aviazione, lanciarazzi, munizioni e uomini {% aff "confermato" %}.
...
I primi quattro M142 **HIMARS** — *High Mobility Artillery Rocket System*, sistema lanciarazzi ad alta mobilità — vengono annunciati dagli Stati Uniti il 1° giugno e raggiungono il fronte nello stesso mese. I razzi guidati **GMLRS** — *Guided Multiple Launch Rocket System* — consentono, nella loro variante standard, fuoco di precisione tra i 70 e gli 80 chilometri, contro bersagli identificati mediante una catena di ricognizione, localizzazione e assegnazione {% aff "confermato" %}. Con i primi lanciatori Kyiv rivendica la distruzione di circa trenta depositi e posti di comando {% aff "plausibile" %}: la cifra resta di fonte ucraina e vale soprattutto come ordine di grandezza. L'effetto generale è invece consolidato {% aff "confermato" %}: l'intensità del fuoco russo cala e depositi, comandi e snodi cominciano a essere colpiti a decine di chilometri dalla linea di contatto.
...
La Russia non resta immobile. Disperde e arretra i depositi oltre la gittata dei GMLRS, li frammenta, allontana comandi e snodi {% aff "confermato" %}. L'adattamento riduce il numero dei bersagli concentrati e quindi il rendimento immediato dei colpi ucraini. Salva la rete, ma trasferisce il costo sul funzionamento della rete stessa: le munizioni devono percorrere distanze maggiori, l'ultimo tratto su gomma si allunga, la distribuzione si frammenta e la cadenza di fuoco si comprime.
...
Ai margini della spina terrestre corrono intanto fili con scansione propria. L'affondamento dell'incrociatore *Moskva* il 14 aprile {% aff "confermato" %}, attribuito ai missili Neptune ucraini {% aff "plausibile" %}, e il primo attacco coordinato di droni navali contro Sebastopoli in ottobre {% aff "plausibile" %} aprono la contesa asimmetrica nel Mar Nero — fronte, questo marittimo, che si rivelerà estremamente profittevole per le forze ucraine. Dopo il colpo al ponte di Kerch dell'8 ottobre {% aff "confermato" %}, la Russia avvia inoltre una campagna contro le infrastrutture energetiche ucraine: una risposta nella profondità strategica che interseca questa fase, ma segue un asse distinto dalla contesa logistica sulla linea di contatto.
...
<div class="grp grp--asc">
  ...
  <div class="grp-head"><svg class="grp-ico" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 19 L19 5"/><path d="M19 12 L19 5 L12 5"/></svg><span class="grp-moto">Ascende</span><span class="grp-tag">interdizione</span></div>
  <div class="el"><div class="el-nome">L'interdizione di precisione a profondità operativa</div><div class="el-txt">Sposta il duello dal fuoco alla <b>logistica del fuoco</b>: colpire il retro senza dover prima prevalere nel volume davanti. La sua efficacia è massima contro nodi concentrati, identificabili e raggiungibili; dispersione, protezione e arretramento ne riducono il rendimento. Il moto inizia qui e si consoliderà quando gittate, numeri e autonomia politica d'impiego cresceranno.</div></div>
</div>
...
<div class="grp grp--dec">
  ...
  <div class="grp-head"><svg class="grp-ico" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 5 L19 19"/><path d="M19 12 L19 19 L12 19"/></svg><span class="grp-moto">Declina</span><span class="grp-tag">retro esposto</span></div>
  <div class="el"><div class="el-nome">La logistica avanzata concentrata</div><div class="el-txt">Il grande deposito prossimo al fronte, alimentato per rotaia, cessa di poter essere assunto come retro protetto. Quando l'avversario dispone di sensori, targeting e fuoco di precisione sufficienti, la concentrazione che sostiene una cadenza elevata diventa una <b>vulnerabilità decisiva</b>. Può riemergere localmente sotto protezione o per rischio accettato, ma non più come presupposto incontestato.</div></div>
</div>
...
<div class="grp grp--tra">
  ...
  <div class="grp-head"><svg class="grp-ico" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 12 a8 8 0 0 1 -13.7 5.6"/><path d="M4 12 a8 8 0 0 1 13.7 -5.6"/><path d="M17.7 3 L17.7 6.4 L14.3 6.4"/><path d="M6.3 21 L6.3 17.6 L9.7 17.6"/></svg><span class="grp-moto">Trasformato</span><span class="grp-tag">mutano ruolo</span></div>
  <div class="el"><div class="el-nome">L'artiglieria</div><div class="el-txt">Non perde centralità: <b>muta ruolo</b>. Resta dominante per volume e capacità distruttiva, ma non può più essere trattata come garanzia autonoma di guadagno territoriale; la sua resa dipende dalla rete che la alimenta a monte e dalle forze che presidiano il terreno a valle.</div></div>
  <div class="el"><div class="el-nome">La logistica come categoria</div><div class="el-txt">Il Prologo l'aveva indicata come limite della manovra; questa fase ne fa il <b>terreno esplicito</b> del confronto. Non più premessa silenziosa del combattimento, ma oggetto deliberato dell'iniziativa avversaria.</div></div>
  <div class="el"><div class="el-nome">La massa di manodopera</div><div class="el-txt">Da superiorità presupposta diventa una variabile da collocare e rigenerare. Kharkiv ne mostra il valore <b>relazionale</b>: il numero complessivo non sostituisce uomini e riserve presenti nel settore decisivo. La mobilitazione è la risposta russa a questa insufficienza.</div></div>
</div>
