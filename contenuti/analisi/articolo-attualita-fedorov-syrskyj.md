---
titolo: "Fedorov — Syrs'kyj: il debito d'integrazione"
data: 2026-07-28
sezione: Attualità
...
immagine:
  ...
  alt: "Da sinistra, Mykhailo Fedorov, Mykhailo Drapatyj e Oleksandr Syrs’kyj"
  credito: "Montaggio Frontiera da fotografie di Reda Raouchaia e del Ministero della Difesa ucraino / Wikimedia Commons."
  licenza: "CC BY-SA 4.0"
  didascalia: "Mykhailo Fedorov, Mykhailo Drapatyj e Oleksandr Syrs’kyj: tre approcci alla trasformazione dell’esercito ucraino."
  posizione: "50% 50%"
infobox:
  tipo: 2
  titolo: "Tre approcci"
  voci:
    - occhiello: "Accelerare la frontiera"
      titolo: "Mykhailo Fedorov"
      testo: "Ridurre il tempo fra sperimentazione, misurazione e adozione, premiando le unità capaci di produrre innovazione efficace."
    - occhiello: "Convertire"
      titolo: "Mykhailo Drapatyj"
      testo: "Ereditare il problema dell’integrazione e trasformare l’iniziativa distribuita in capacità condivisa dall’esercito."
    - occhiello: "Preservare la coerenza"
      titolo: "Oleksandr Syrs’kyj"
      testo: "Integrare la trasformazione senza frammentare un esercito di massa né separare l’innovazione dalla responsabilità operativa."
---
...
Nel giro di una settimana, una divergenza rimasta a lungo interna allo Stato ucraino è diventata una crisi pubblica. Il 15 luglio 2026 Mykhailo Fedorov non è stato confermato alla guida del Ministero della Difesa. Fra il 16 e il 17 luglio, nel [tracciare un bilancio del proprio mandato](https://nv.ua/ukr/opinion/vidstavka-fedorova-z-posadi-ministra-oboroni-osnovni-dosyagnennya-i-problemi-konflikt-iz-sirskim-50624891.html), ha dichiarato di avere chiesto al presidente Volodymyr Zelenskyj la sostituzione del comandante in capo Oleksandr Syrs’kyj. Ha accusato il vertice militare di distribuire risorse secondo lealtà, bloccare iniziative, frammentare le unità e non trasformare i dati sulle perdite in decisioni. Il 20 luglio [Syrs’kyj ha risposto](https://ukrnews.live/war/oleksandr-syrskyj-moia-robota-vijna/) rivendicando la responsabilità del comando su strategia e operazioni: un esercito di circa un milione di persone, ha sostenuto, non può essere riconvertito attraverso presentazioni, classifiche o messaggistica, né portato «sui droni» in due mesi senza rischiare vite e territorio. Il giorno seguente [Zelenskyj ha annunciato](https://www.president.gov.ua/en/news/ya-viznachiv-sho-novim-golovnokomanduvachem-zbrojnih-sil-ukr-105541) la nomina di Mykhailo Drapatyj al vertice delle Forze armate.
...
I programmi sorti attorno a questa grammatica svolgono funzioni diverse. [Army of Drones](https://www.president.gov.ua/en/news/simvol-nezlamnosti-platforma-united24-prezentuvala-brasleti-78317) e il cluster [Brave1](https://digitalstate.gov.ua/projects/tech/brave1) collegano domanda operativa, sperimentazione, imprese e acquisto; in un [intervento del 2023](https://www.atlanticcouncil.org/blogs/ukrainealert/ukraines-growing-defense-tech-prowess-can-help-defeat-russia/), Fedorov descriveva già Brave1 come un raccordo rapido fra militari, sviluppatori, Stato e investitori. Il sistema [DELTA](https://mod.gov.ua/en/news/the-delta-combat-system-has-been-deployed-across-all-levels-of-defence-forces-of-ukraine) e il suo modulo [Mission Control](https://mod.gov.ua/en/news/two-months-since-the-launch-of-mission-control-within-the-delta-ecosystem-the-system-is-now-operational-across-all-corps-and-force-groupings) portano dati e missioni senza equipaggio dentro un quadro comune di consapevolezza situazionale e comando. Il marketplace DOT-Chain Defence interviene invece nell’allocazione, nella verifica e nella distribuzione delle risorse. Nel loro insieme, questi strumenti fanno dell’unità al fronte un utilizzatore, uno sperimentatore e un produttore di informazioni; l’impresa riceve un problema operativo e modifica il sistema in cicli brevi; lo Stato mette più soluzioni in competizione sotto la pressione dell’impiego reale.
...
La controffensiva ucraina del 2023 offre un precedente alla sua cautela. Piattaforme e reparti promettenti operarono dentro un complesso incompleto: sotto osservazione e fuoco persistenti, mancavano in misura sufficiente coordinamento, capacità di breccia e sostegno logistico. Il rapporto del [Royal United Services Institute](https://www.rusi.org/explore-our-research/publications/special-resources/preliminary-lessons-ukraines-offensive-operations-2022-23) mostra quanto rapidamente una capacità perda valore quando il sistema necessario al suo impiego non riesce a sostenerla. La rivoluzione degli FPV non ha abolito artiglieria e fanteria: ne ha trasformato il modo di muoversi, disperdersi, osservare e combattere.
...
{{ debitoIntegrazione({ id: "debito-fedorov-syrskyj" }) }}
...
La nomina di Mykhailo Drapatyj è stata presentata come una possibile sintesi. Il termine è corretto soltanto se non indica un compromesso equidistante. Drapatyj è più vicino a Fedorov sul ritmo della riforma, sull’iniziativa dei subordinati e sul rapporto fra risultato e responsabilità. Da comandante delle Forze terrestri ha promosso addestramento pratico, ruolo dei sergenti, logistica digitale e tecnologia accessibile alla fanteria; al termine di quell’esperienza ha [contrapposto alla lealtà](https://kyivindependent.com/drapatyi-ends-ground-forces-tenure-citing-reforms-says-he-leaves-with-clear-conscience/) decisioni fondate su analisi, risultati e rispetto. Dopo l’attacco russo a un centro di addestramento nel giugno 2025 lasciò l’incarico dichiarandosi responsabile. Nel luglio 2026 [ha sostenuto pubblicamente Fedorov](https://english.nv.ua/nation/drapatyi-spoke-of-need-for-reforms-in-ukraine-s-armed-forces-and-expressed-support-for-fedorov-50624912.html).
...
Il mandato annunciato da Zelenskyj gli affida la riforma dei corpi, l’aggiornamento della strategia di difesa e la continuità delle capacità senza equipaggio e degli attacchi in profondità. Il 20 luglio, ancora prima della nomina, la [Presidenza aveva riunito](https://www.president.gov.ua/en/news/prezident-proviv-specialnu-zustrich-stavki-za-pidsumkami-kil-105537) comandanti di corpo, produttori, Difesa e Finanze per discutere difetti, ritardi, contratti e priorità. È la forma iniziale di un’interfaccia fra utilizzatore, produttore e governo; non ancora una riforma.
