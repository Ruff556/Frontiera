---
titolo: "Storm Shadow in Ucraina: la fabbrica entra nella profondità"
slug: storm-shadow-ucraina-fabbrica-profondita
data: 2026-08-25
sezione: Attualità
...
infobox:
  tipo: 2
  titolo: "Dall’accordo alla capacità"
  voci:
    - occhiello: "Atto compiuto"
      titolo: "Autorizzazione"
      testo: "Francia e Ucraina hanno concordato la produzione su licenza; Londra ha consentito a MBDA di condividere le informazioni classificate necessarie sui componenti britannici."
    - occhiello: "Capacità in costruzione"
      titolo: "Linea ucraina"
      testo: "L’obiettivo dichiarato è avviare entro la fine del 2026 linee locali di assemblaggio. Workshare, rateo e calendario di qualificazione sono ancora da determinare."
    - occhiello: "Criterio operativo"
      titolo: "Ricostituzione"
      testo: "Il programma acquisterà valore se tradurrà l’output industriale in missioni e sosterrà la capacità ucraina di rigenerarsi sotto l’attacco russo."
immagine:
  file: /immagini/attualita/a2-scalp-eg-su24.jpg
  alt: "Un missile da crociera SCALP EG montato sotto l'ala di un Su-24M ucraino."
  credito: "Кадр з відео Ігоря Смілянського / Wikimedia Commons"
  licenza: "CC0 1.0"
  didascalia: "Un missile SCALP EG sotto l'ala di un Su-24M ucraino."
---

Storm Shadow combatte in Ucraina dal 2023. È partito da un velivolo sovietico adattato per portarlo, ha attraversato la difesa russa a bassa quota e ha colpito bacini navali, posti di comando, infrastrutture militari e impianti dell’industria bellica {% affV1 "A2-E001" %}. Ogni missile impiegato da Kyiv iniziava però la propria storia negli arsenali franco-britannici prima di entrare in quella della guerra ucraina.

Il 24 agosto 2026 Londra ha aperto un passaggio diverso. Il governo britannico ha [autorizzato MBDA a condividere informazioni classificate](https://www.gov.uk/government/news/britain-is-100-behind-you-prime-minister-andy-burnham-visits-kyiv-on-ukrainian-independence-day-for-first-international-trip) sui componenti di propria competenza, affinché Francia e Ucraina possano creare linee locali di assemblaggio. L’assenso completa sul versante britannico la [dichiarazione franco-ucraina del 14 luglio](https://www.elysee.fr/en/emmanuel-macron/2026/07/14/joint-declaration-by-the-president-of-the-french-republic-and-the-president-of-ukraine), che prevede la produzione su licenza in Ucraina di AASM e SCALP, da avviare appena possibile ed entro la fine del 2026 {% affV1 "A2-E002" %}.
...
Per comprendere che cosa l’Ucraina voglia rigenerare occorre guardare alla funzione acquistata dallo SCALP. [MBDA lo descrive](https://www.mbda-systems.com/products/deep-strike/storm-shadow-scalp) come un missile da crociera aviolanciato per attacchi pre-pianificati contro obiettivi fissi o stazionari di alto valore. Il profilo a bassa quota, la navigazione inerziale e satellitare assistita dal riferimento al terreno, il riconoscimento terminale a infrarossi e una testata penetrante a due stadi concorrono allo stesso compito: portare un effetto prevedibile dentro un bersaglio per il quale un errore di pochi metri può vanificare l’intera missione {% affV1 "A2-E004" %}. È il caso di una struttura indurita, di un bacino navale, di un posto di comando o di un nodo industriale selezionato.

L’Ucraina ha già dimostrato di saper convertire questa capacità in impiego. Nel 2023 [adattò i Su-24](https://militarnyi.com/en/news/how-russian-targets-are-destroyed-the-first-video-of-storm-shadow-launches-from-ukrainian-su-24s/), velivoli concepiti in Unione Sovietica, a un’arma occidentale estranea alla loro architettura originaria {% affV1 "A2-E005" %}. Il numero di aerei disponibili e la quota configurata per Storm Shadow / SCALP sono protetti dalla sicurezza operativa. Proprio la piattaforma stabilisce un limite concreto: scorte più ampie generano più missioni soltanto se esistono velivoli, equipaggi, basi, manutenzione e finestre di lancio sufficienti.

Il [13 settembre 2023](https://www.reuters.com/world/europe/ukraine-launches-missile-attack-sevastopol-crimea-russian-installed-governor-2023-09-13/), dieci missili da crociera e tre mezzi di superficie senza equipaggio investirono Sebastopoli. Le immagini successive mostrarono i gravi danni alla nave da sbarco *Minsk* e al sottomarino *Rostov-on-Don* nel bacino di carenaggio {% affV1 "A2-E006" %}; Mosca dichiarò di avere intercettato sette missili. [Nove giorni dopo](https://www.reuters.com/world/europe/russian-official-says-ukraine-struck-black-sea-navy-hq-with-missile-2023-09-22/) fu colpito il quartier generale della Flotta del Mar Nero. Questi attacchi contribuirono, insieme a Neptune, ATACMS, droni marittimi, ricognizione e pressione ripetuta, a spingere navi e attività russe verso porti più orientali. Il danno prodotto dallo SCALP è documentato; l’arretramento della flotta appartiene all’effetto composito dell’intera campagna {% affV1 "A2-E007" %}.

Dal [novembre 2024](https://www.reuters.com/world/europe/ukraine-fires-uk-storm-shadow-cruise-missiles-into-russia-day-after-using-us-2024-11-20/) il missile è comparso anche oltre il confine internazionalmente riconosciuto della Federazione Russa. Nel 2025 e nel 2026 Kyiv lo ha associato ad attacchi contro posti di comando e industria militare, compreso lo [stabilimento microelettronico Kremniy El’](https://www.reuters.com/business/aerospace-defense/zelenskiy-says-ukraines-military-hit-key-russian-missile-plant-bryansk-region-2026-03-10/) di Brjansk nel marzo 2026 {% affV1 "A2-E008" %}. L’ampiezza del *target set* è quindi cresciuta. Il regime attuale delle autorizzazioni geografiche, dei consensi sui bersagli e della partecipazione occidentale alla costruzione dei dati di missione conserva invece una zona opaca {% affV1 "A2-E009" %}.
...
**Il confronto con FP-5 Flamingo rende visibili le due economie dell’attacco**. Fire Point dichiara per il proprio missile ucraino un lancio terrestre, una gittata massima di circa 3.000 chilometri e una testata nell’ordine di 1.150 chilogrammi. Le [autorità ucraine](https://mod.gov.ua/en/news/since-the-start-of-the-year-ukraine-s-defense-forces-have-struck-three-major-russian-military-plants-two-arsenals-and-a-key-test-range) ne confermano la produzione seriale e l’impiego reiterato {% affV1 "A2-E010" %}; prestazioni, precisione e ratei dipendono soprattutto da dichiarazioni aziendali e governative. Nell’[aprile 2026](https://www.reuters.com/business/aerospace-defense/ukraine-missile-maker-targets-game-changer-air-defence-system-by-2027-2026-04-06/) l’impresa indicava un costo vicino ai 600.000 euro e tre esemplari al giorno; in luglio parlava di circa cento al mese {% affV1 "A2-E011" %}. Il motore figurava ancora fra i colli di bottiglia {% affV1 "A2-E012" %}.
...
La coesistenza dei mezzi è osservabile. Il loro coordinamento regolare in una medesima architettura offensiva richiede un grado di prova più alto. Sebastopoli nel settembre 2023 offre un caso solido di attacco simultaneo con missili e mezzi navali senza equipaggio; la ripartizione delle funzioni fra le componenti è ignota. Nel [maggio 2026](https://www.reuters.com/business/aerospace-defense/sevastopol-governor-says-ukraine-used-storm-shadow-missiles-attack-2026-05-27/) le autorità russe hanno descritto un nuovo attacco contro la città con oltre venti droni e Storm Shadow, senza dati pubblici sufficienti su rotte, tempi ed effetti.

Le prove diventano più forti quando lo sguardo si allarga dalla singola salva alla campagna. Nell’[aprile 2026](https://www.reuters.com/world/europe/ukraine-steps-up-medium-range-strikes-russian-forces-2026-05-05/) le forze ucraine hanno dichiarato oltre 160 attacchi nella fascia fra 120 e 150 chilometri, comprendenti 25 sistemi di difesa aerea e 13 radar o apparati di guerra elettronica. Il comandante delle Forze dei sistemi senza equipaggio, Robert Brovdi, ha presentato questa pressione come apertura di corridoi per i colpi più profondi {% affV1 "A2-E013" %}. È documentato l’intento di degradare la protezione prima di investire il retro russo; la chiusura del ciclo, bersaglio dopo bersaglio, sfugge alle fonti aperte {% affV1 "A2-E014" %}.

Si può dunque parlare di un’architettura emergente e parzialmente coordinata {% affV1 "A2-E015" %}. La massa moltiplica i problemi e raccoglie informazioni; i sistemi nazionali estendono raggio, volume e libertà politica; gli effettori pregiati concentrano l’accesso su bersagli selezionati. **La futura linea SCALP potrebbe rendere il terzo strato meno episodico**. La qualità della campagna dipenderà da come Kyiv comporrà questi mezzi, prima ancora che dal loro inventario separato.
...
1. Può sostituire una parte dei consumi e conservare una capacità selettiva.
2. Può costruire una riserva e aumentare la cadenza.
3. Può trasferire abbastanza processi da alimentare anche lo sviluppo dell’industria missilistica ucraina nel suo complesso. 
...
Il [Cremlino ha reagito](https://www.reuters.com/world/europe/kremlin-says-british-missile-help-ukraine-adds-fuel-fire-2026-08-24/) all’annuncio dichiarando che la Russia raccoglierà informazioni per **individuare e distruggere i siti produttivi**. La minaccia poggia su una capacità già dimostrata: Mosca può colpire l’intero territorio ucraino e ha rivolto salve ripetute contro energia, fabbriche missilistiche, officine dronistiche e nodi logistici.
...
Fire Point ha già sperimentato la relazione. Nel [febbraio 2026](https://kyivindependent.com/russian-strike-temporarily-delayed-production-of-ukraines-flamingo-missiles-zelensky-says/) due grandi officine furono distrutte e la produzione di Flamingo subì un ritardo temporaneo {% affV1 "A2-E018" %}; l’azienda dichiarò di avere mantenuto gli impegni grazie a una **rete di siti** e alla **ridondanza logistica**. Il caso stabilisce un criterio più utile del semplice conteggio degli edifici danneggiati: **un attacco industriale riesce quando interrompe la funzione più rapidamente di quanto il produttore riesca a trasferirla, ripararla o sostituirla**.

La linea SCALP inserisce questo criterio nella [campagna di profondità](/profondita/attacco-sistemico-profondita-difesa/). Kyiv deve ricevere componenti, assemblare, collaudare, disperdere le scorte e ripristinare ciò che Mosca colpisce. La Russia deve scoprire i siti, ricostruirne la funzione, attraversarne la protezione e tornare prima che la rete recuperi. Ogni parte tenta di imporre il proprio tempo all’altra.
...
Il caso più chiaro è [Stone Cloak](https://www.gov.uk/government/news/unbreakable-bond-between-uk-and-ukraine-will-continue-under-my-government-26-july-2026). Il Regno Unito ha sviluppato un disturbatore miniaturizzato, lo ha fatto provare sul fronte ucraino, ha raccolto il feedback e nel luglio 2026 ne ha trasferito la proprietà intellettuale affinché Kyiv possa produrlo in massa. Londra prevede poi di reinserirlo nei propri futuri sistemi d’attacco profondo, compreso Project Brakestop. Qui il ciclo è intero e documentato: tecnologia britannica, prova ucraina, esperienza del campo, produzione in Ucraina, ritorno nella capacità britannica {% affV1 "A2-E019" %}.

[Brakestop](https://www.gov.uk/government/news/uk-accelerates-long-range-strike-capability-for-ukraine) rende esplicito anche il tentativo europeo di apprendere la velocità: in sette mesi, ventisette proposte sono diventate sei prototipi e poi tre finalisti, con prove previste in Ucraina. Lo stesso avvicinamento attraversa lo [sviluppo congiunto di NEPTUNE2](https://www.mbda-systems.com/mbda-develop-neptune2-cruise-missile-luch) e la [partnership fra MBDA e Ukrainian Armor](https://www.mbda-systems.com/mbda-and-ukrainian-armor-strategic-partnership-develop-deep-strike-c-uas-capabilities). Programmi diversi, qui rilevanti per la relazione che documentano: l’industria europea entra nello sviluppo ucraino mentre l’esperienza ucraina rientra nei programmi europei.
