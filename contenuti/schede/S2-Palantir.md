...
Fra il 2023 e il 2024 la stessa architettura viene configurata per istituzioni e oggetti differenti. Palantir stipula un accordo con l’Ufficio del Procuratore generale ucraino per **collegare episodi, prove e unità russe nelle indagini sui crimini di guerra** {% affV1 "S2-E005" %}. Nello **sminamento**, dati sulla contaminazione, la popolazione, l’agricoltura, le infrastrutture e la disponibilità di squadre vengono combinati per proporre priorità e metodi {% affV1 "S2-E006" %}.
