...
immagine:
  ...
  alt: "Logo Bureau 1440, sviluppatore del progetto Rassvet"
  credito: "Bureau 1440, via Wikimedia Commons"
  licenza: "Dominio pubblico per la componente grafica semplice; marchio registrato"
  fit: contain

infobox:
  tipo: 2
  titolo: "Tre soglie della capacità"
  voci:
    - occhiello: "Dimostrazione"
      titolo: "Il collegamento riesce"
      testo: "Rassvet ha provato comunicazioni broadband, 5G NTN e collegamenti laser su piccoli gruppi di satelliti. Una prova riuscita dimostra competenza, non ancora disponibilità continuativa."
    - occhiello: "Continuità"
      titolo: "Il passaggio diventa servizio"
      testo: "La capacità matura richiede satelliti abbastanza densi, handover, terminali seriali, gateway, controllo di rete e sostituzioni: ogni strato deve funzionare insieme agli altri."
    - occhiello: "Sovranità"
      titolo: "La dipendenza viene trasferita"
      testo: "Una rete nazionale ridurrebbe il potere di un fornitore estero su accesso e geofencing, ma renderebbe la continuità dipendente dalla produzione e dalla logistica russe."
---
...
Il primo dimostratore Rassvet-1, formato da tre satelliti, venne lanciato il 27 giugno 2023. Bureau 1440 dichiarò una connessione bidirezionale a 48 Mbit/s e 41 millisecondi durante le prove {% affV1 "S3-E003" %}. Il 17 maggio 2024 altri tre apparati formarono Rassvet-2, con cui l’azienda sperimentò un collegamento laser intersatellitare a 10 Gbit/s e una connessione fra satellite e terminale basata sullo standard 5G NTN {% affV1 "S3-E004" %}.
...
Il salto verso la produzione seriale iniziò nel 2026. Il 23 marzo un Soyuz-2.1b partì dal cosmodromo di Plesetsk con sedici RASSVET-3; un secondo lancio ne portò in orbita altri sedici il 19 luglio {% affV1 "S3-E005" %}. In meno di quattro mesi Bureau 1440 passò così da gruppi sperimentali di tre apparati a due serie da sedici.

«Lanciato», tuttavia, non significa «operativo». Al 3 agosto uno dei satelliti di marzo era già rientrato; gli altri occupavano quote molto diverse, così come la seconda serie, ancora attorno a 316–323 chilometri {% affV1 "S3-E006" %}. Bureau 1440 continua a pubblicizzare una quota di progetto di 800 chilometri, ma non ha chiarito se gli apparati osservati stessero completando il trasferimento, eseguendo prove o anticipando una configurazione differente {% affV1 "S3-E007" %}.
...
Il divario continua nel segmento meno spettacolare. Il terminale Standard di Starlink pesa 2,9 chilogrammi senza supporto ed è prodotto in massa. Il prototipo Rassvet presentato nel 2025 pesava circa 15 chilogrammi; costo, consumo, robustezza e produzione seriale non sono pubblici {% affV1 "S3-E011" %}. SpaceX, inoltre, oltre a disporre della costellazione, è proprietaria del vettore predisposto ai lanci, che sono perciò **gestiti autonomamente**. Bureau 1440 dipende da Soyuz, Plesetsk e dal calendario dell’apparato statale russo.
...
Nel teatro ucraino la Russia ha conosciuto Starlink prima come capacità dell’avversario e poi come servizio di cui appropriarsi. Dal 2024 l’intelligence ucraina ha documentato terminali utilizzati da reparti russi nei territori occupati. Hardware acquistato attraverso intermediari e account registrati in Paesi terzi permisero a Mosca di usare una rete che SpaceX non vendeva ufficialmente in Russia {% affV1 "S3-E012" %}.
...
Nel febbraio 2026 Ucraina e azienda introdussero una whitelist. Nella zona di guerra soltanto i terminali verificati da Kyiv potevano continuare a operare; il Ministero della Difesa ucraino dichiarò che quelli russi non autorizzati erano già stati bloccati {% affV1 "S3-E013" %}. Fonti russe descrissero interruzioni importanti, ma la scala dell’effetto non è ricostruibile con inventari indipendenti {% affV1 "S3-E014" %}.

La misura completa il caso aperto in [Starlink](/schede/starlink/). Una rete può essere difficile da distruggere satellite per satellite e rimanere vulnerabile a una decisione nel piano di controllo. La contromisura non colpisce l’antenna o la costellazione, ma l’identità che permette loro di incontrarsi.
...
Nel giugno 2026 Putin ha indicato Bureau 1440 come risposta alla necessità di controllare droni pesanti via satellite e ha affermato che il sistema non sarebbe inferiore a Starlink {% affV1 "S3-E016" %}. La prima parte prova l’intento militare; la seconda non è sostenuta dalla scala e dalla maturità oggi osservabili.

Un collegamento satellitare potrebbe sostenere telemetria, aggiornamenti di missione, trasmissione video o backhaul campale. Per trasformare la possibilità in impiego servono però copertura, terminali resistenti, energia, priorità di traffico e integrazione con le reti russe. Su un drone si aggiungono massa, consumo e orientamento dell’antenna. Le fonti aperte mostrano finora un terminale da circa 15 kg, ma non consentono di stabilire se esistano soluzioni più leggere né se il terminale possa assolvere tutte queste funzioni in impiego operativo {% affV1 "S3-E017" %}.

Il 10 agosto il vicecapo dell’intelligence militare ucraina, Vadym Skibitskyi, ha dichiarato che Rassvet procedeva più rapidamente delle attese e poteva già fornire comunicazioni frammentarie durante i passaggi {% affV1 "S3-E018" %}. L’avvertimento mostra che la costellazione è entrata nel calcolo ucraino, ma non chiarisce quale precedente stima del GUR sia stata superata. Rispetto invece al calendario federale russo pubblicato, il programma risultava essere in ritardo.

La possibilità di finestre sopra l’Ucraina è tecnicamente coerente. Al 18 agosto non esiste però una misura pubblica della disponibilità, né è documentato l’impiego di terminali Rassvet da parte delle forze russe. Nessun aumento della continuità di comando, del controllo di droni o recupero della capacità perduta con la whitelist può essere attribuito alla rete {% affV1 "S3-E019" %}.
...
- [Bureau 1440 — identità, cronologia, architettura e obiettivi del sistema](https://1440.space/en/)
- [Cremlino — Rassvet come «risposta a Starlink», 6 giugno 2025](https://special.kremlin.ru/catalog/keywords/76/events/77115)
- [Interfax — secondo lancio RASSVET-3, 20 luglio 2026](https://www.interfax.ru/russia/1104308)
- [Interfax — dichiarazioni sulla costellazione e sul controllo dei droni, 12 giugno 2026](https://www.interfax.ru/russia/1095574)
- [Ministero russo dello Sviluppo digitale — oltre 290 satelliti previsti entro il 2027](https://digital.gov.ru/news/ekonomika-dannyh-bolee-290-sputnikov-svyazi-planiruetsya-vyvesti-na-orbitu-k-konczu-2027-goda)
- [ComNews — costellazione, finanziamento e piano di sostituzione, 6 marzo 2025](https://www.comnews.ru/content/238109/2025-03-06/2025-w10/1008/vice-premer-dmitriy-grigorenko-pereschital-sputniki-byuro-1440)
- [ComNews — clienti, prezzi e pilotaggi, 18 marzo 2025](https://www.comnews.ru/content/238304/2025-03-18/2025-w12/1008/byuro-1440-rasschitalo-stoimost-uslug-dlya-zakazchikov)
- [Kommersant — requisiti di rete, spettro e componenti, 18 gennaio 2025](https://www.kommersant.ru/doc/7442855)
- [Kommersant — rinvio della prima serie e calendario industriale, 23 gennaio 2026](https://www.kommersant.ru/doc/8364882)
- [ComNews — stato orbitale dei 32 RASSVET-3, 4 agosto 2026](https://www.comnews.ru/content/246700/2026-08-04/2026-w32/1007/ozhidanii-rassveta-do-konca-2026-g-u-byuro-1440-ostalos-esche-7-puskov)
- [Ministero della Difesa ucraino — introduzione della verifica Starlink, 2 febbraio 2026](https://mod.gov.ua/en/news/ukraine-rolls-out-starlink-terminal-verification-to-counter-russian-aerial-terror)
- [Ministero della Difesa ucraino — blocco dei terminali russi, 5 febbraio 2026](https://mod.gov.ua/en/news/starlink-terminals-on-the-whitelist-remain-operational-while-russian-terminals-have-already-been-blocked)
- [Reuters — valutazione del GUR sul dispiegamento Rassvet, 10 agosto 2026](https://www.reuters.com/business/media-telecom/russia-rolling-out-starlink-style-network-faster-expected-kyiv-says-2026-08-10/)
- [Starlink — specifiche del servizio](https://www.starlink.com/legal/documents/DOC-1431-92252-65)
- [Starlink — tecnologia della costellazione e collegamenti laser](https://starlink.com/technology)
