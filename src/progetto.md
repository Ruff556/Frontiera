...
permalink: /progetto/index.html
titoloPagina: Il progetto Frontiera
...
Gli indicatori {% aff "confermato" %}, {% aff "plausibile" %} e {% aff "non-verificato" %} non certificano differenti quantità di verità. Dichiarano il grado di corroborazione raggiunto, in quel momento, dalla nostra sintesi.
...
Questa licenza non si estende al codice sorgente, ai template, ai fogli di stile, agli script o agli altri componenti software e infrastrutturali del progetto, che rimangono proprietari e non sono concessi al riuso. Marchio, nome e identità visiva di Frontiera sono parimenti esclusi dalla licenza CC BY 4.0.

Materiali provenienti da terzi, comprese immagini, dati cartografici o altre risorse incorporate nel sito, rimangono soggetti alle rispettive licenze e attribuzioni.

La distinzione è intenzionale: **la conoscenza prodotta da Frontiera è fatta per poter circolare; l'infrastruttura originale con cui Frontiera la produce e la presenta rimane parte del progetto.**

## Sostieni Frontiera

Frontiera nasce e viene sviluppato come progetto indipendente, senza una struttura editoriale alle spalle.

Ricerca, verifica delle fonti, sviluppo del sito, produzione delle rappresentazioni e mantenimento dell'archivio fanno parte del lavoro ordinario di Frontiera. Chi desiderasse riconoscere al progetto un contributo economico è libero di farlo.

<div class="support-action">
  <a class="support-cta" href="https://buy.stripe.com/28EcN86LU4ec5up6oP5kk00" aria-label="Sostieni Frontiera tramite Stripe">SOSTIENI FRONTIERA</a>
</div>

Il sostegno non dà accesso a contenuti riservati e non modifica la linea editoriale. Contribuisce semplicemente a rendere sostenibile la prosecuzione di Frontiera.
